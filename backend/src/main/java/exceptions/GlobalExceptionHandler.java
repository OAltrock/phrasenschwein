...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleSelfUserDeletionException(SelfUserDeletionException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errorBody(HttpStatus.BAD_REQUEST, ex.getMessage()));
    }

    @ExceptionHandler(UserHasBalanceException.class)
    public ResponseEntity<Map<String, Object>> handleUserHasBalanceException(UserHasBalanceException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(errorBody(HttpStatus.CONFLICT, ex.getMessage()));
    }
